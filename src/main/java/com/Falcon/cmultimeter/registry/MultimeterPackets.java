...
import com.Falcon.cmultimeter.content.blocks.kinetics.multimeter.GaugeObservedPacket;
...
public enum MultimeterPackets {
	...
	public static final ResourceLocation CHANNEL_NAME = MultimeterCreate.asResource("main");
	...
	<T extends SimplePacketBase> MultimeterPackets(Class<T> type, Function<FriendlyByteBuf, T> factory,
	...
	public static void registerPackets() {
		...
		for (MultimeterPackets packet : values())
